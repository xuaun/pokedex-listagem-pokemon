...
<p align="center">
<img src="./src/images/navegar.gif" alt="Scroll navigation screen, with Pokémon in numerical order" title="Navigation without search" width="600" />
</p>

2. Search by name/number and/or by the types of the desired Pokémon;

<p align="center">
<img src="./src/images/buscar.gif" alt="Search navigation screen" title="Navigation with search" width="600" />
</p>

3. You can also switch between light/dark mode in the upper right corner;

<p align="center">
<img src="./src/images/modos.gif" alt="Screen switching between light and dark mode when clicking on the mode change icon" title="Light/Dark Mode" width="600" />
</p>
...
<p align="center">
  <img src="./src/images/navegar.gif" alt="Tela de navegação por scroll, com pokémons em ordem numérica" title="Navegação sem busca" width="600" />
</p>

2. Buscar por nome/número e/ou pelos tipos do pokémon desejado;

<p align="center">
  <img src="./src/images/buscar.gif" alt="Tela de navegação por busca" title="Navegação com busca" width="600" />
</p>

3. Você também pode, no canto superior direito, alternar entre o modo claro/escuro;

<p align="center">
  <img src="./src/images/modos.gif" alt="Tela alternando entre modo claro e escuro ao clicar no ícone de mudança de modo" title="Modo claro/escuro" width="600" />
</p>
